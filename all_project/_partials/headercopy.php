    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto ">
            ...
            <?php if (isset($_SESSION['email'])): ?>
                <li class="nav-item">
                    <a  class="nav-link waves-effect waves-light" href="<?= $site_url ?>logout.php">Odhlásit sa</a>
                </li>               <!--poznamka odhlasit sa anglicky-->


                <?php else:?>
                <li class="nav-item">
                    <a  class="nav-link waves-effect waves-light" href="<?= $site_url ?>login.php">Prihlásiť sa </a>
